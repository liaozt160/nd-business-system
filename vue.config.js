...
module.exports = {
  ...
  publicPath: process.env.ENV === 'development'?'./':process.env.ENV === 'staging'?'http://resource.newdreamservices.com/':process.env.ENV === 'production'?'https://newdreamservice-sk.s3.ap-northeast-2.amazonaws.com/prod/':'./',
