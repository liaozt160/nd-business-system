...
module.exports = {
  ...
  publicPath: process.env.ENV === 'development'?'./':process.env.ENV === 'staging'?'https://resource.newdreamservices.com/dev/':process.env.ENV === 'production'?'https://resource.newdreamservices.com/prod/':'./',
